            ...
            <body class="bg-gradient-to-br from-blue-500 to-purple-600 min-h-screen flex items-center justify-center p-4">
                <div class="bg-white p-8 rounded-lg shadow-xl max-w-md w-full text-center">
                    ...
                    <p class="text-md text-gray-700 mt-6">
                        Join my Telegram channel for more updates: <a href="https://t.me/vlesso4ka" class="text-blue-600 hover:underline" target="_blank">https://t.me/vlesso4ka/a>
                    </p>
                </div>
                ...
                <script>
                    document.addEventListener('DOMContentLoaded', () => {
                        ...
                        getConfigBtn.addEventListener('click', async () => { // Made the function async to use await
                            ...
                            const uri = \`vless://\${serverUuid}@\${serverHost}:443?security=tls&fp=randomized&type=ws&host=\${serverHost}&encryption=none#Lade-By-vlesso4ka\`;
                            vlessUri.value = uri;
